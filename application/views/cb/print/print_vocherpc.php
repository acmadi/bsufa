<?php
			...
			$coa = $this->db->select('acc_name')
								   ->where('acc_no',$row->acc_no)
								   ->get('db_coa')->row();
			
			$pdf->SetX(10);
			$pdf->Cell(8,4,$no,1,0,'C',0);
			$pdf->Cell(26,4,$row->acc_no,1,0,'L',0);
			$pdf->Cell(78,4,$coa->acc_name,1,0,'L',0);
			...
			$pdf->SetX(10);
			$pdf->Cell(8,4,$no+1,1,0,'C',0);
			$pdf->Cell(26,4,'1110.2602.1',1,0,'L',0);
			$pdf->Cell(78,4,'Bank Pengelola EPRJ - 1',1,0,'L',0);
